...
public class Tabuleiro {
    ...
    */
    ...
    public List<List<MovimentoEstado>> caminhosDisponiveis(int lin,int col,boolean capturado) {
    	 List<List<MovimentoEstado>> saida = new ArrayList<List<MovimentoEstado>>();
         
         List<MovimentoEstado> estados = getEstado().movimentosPossiveis(lin, col, capturado,new MovimentoEstado(matrizCasas[lin][col], getEstado()));//new MovimentoEstado(matrizCasas[lin][col],estado)
